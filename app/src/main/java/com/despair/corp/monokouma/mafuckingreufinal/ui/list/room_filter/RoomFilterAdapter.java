...
public class RoomFilterAdapter extends ListAdapter<MeetingViewStateRoomFilterItem, RoomFilterAdapter.ViewHolder> {
    ...
    @NonNull
    private final OnRoomSelectedListenner listener;

    public RoomFilterAdapter(@NonNull OnRoomSelectedListenner listener) {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(
                ...
                @NonNull final OnRoomSelectedListenner listener
        ) {
