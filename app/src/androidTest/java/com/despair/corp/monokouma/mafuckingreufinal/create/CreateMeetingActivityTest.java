...
public class CreateMeetingActivityTest {
    ...
    public void nominal_case() {
        ...
        CreateMeetingTestUtils.create_meeting("foo", "bar, baz", Room.Moscou);

        //Ask nino : comment trouver le bouton du pop up de l'heure
     //   onView(withId(R.id.create_meeting_hour_tv)).perform(click());
    ...
    public void on_empty_user_input() {
        //Full empty
        CreateMeetingTestUtils.create_meeting("", "", null);
        ...
        CreateMeetingTestUtils.create_meeting("foo", "", null);
        ...
        CreateMeetingTestUtils.create_meeting("foo", "bar, baz", null);
        ...
        //Full filled
        CreateMeetingTestUtils.create_meeting("foo", "bar, baz", Room.Pekin);
